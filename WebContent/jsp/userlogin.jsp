	...
	<div class="header">
		...
		<div class="headerNav">
			<a target="_blank" href="../index.jsp">主页</a> <a target="_blank"
				href="${pageContext.request.contextPath }/jsp/userregister.jsp">用户注册</a>
			<a target="_blank"
	...
	<div class="banner">
		<div class="login-aside">
			...
			<div id="o-box-down" style="table-layout: fixed;">
				...
				<form action="../servlet/doUserloginServlet" method="post">
					<div class="fm-item">
						<h1>&nbsp;  用户登陆</h1>
						<label for="logonId" class="form-label2">账号：</label>
						<p>
							<input type="text" id=loginname name="loginname" class="i-text"/>
							<div id="loginnameerror" style="font-family: 楷体;"> ${loginnameerror}</div>
						</p>
					...
					<div class="fm-item">
						...
						<p>
							<input type="password" id="loginpass" class="i-text"
								name="loginpass" /><span id="loginpasserror"></span>
						</p>
						<div class="ui-form-explain"></div>
					</div>
