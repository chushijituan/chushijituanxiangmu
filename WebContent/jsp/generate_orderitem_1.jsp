	...
	<div id="table_body">
		...
		<div id="table_new">
			<table>
				...
				<tr>
					<td width="20%" id="xxx">
						<a href="<html:url value='/servlet/OrderServlet?method=load&oid=${order.oid }&btn=cancel'/>">取消</a>
					</td>
				</tr>
				<tr>
					<td width="20%" id="xxx">
						<a href="<html:url value='/servlet/OrderServlet?method=load&oid=${order.oid }&btn=confirm'/>">确认</a>
					</td>
				</tr>
			</table>
		</div>
